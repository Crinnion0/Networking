...
void Scene2::OnInitializeScene()
{
	...
	this->AddGameObject(BuildCuboidObject("Wall1", Vector3(0.0f, 2.5f, 0.0f), Vector3(1.0f, 2.5f, 5.0f), true, 0.0f, true, false, Vector4(0.2f, 0.5f, 1.0f, 1.0f)));
	this->AddGameObject(BuildCuboidObject("Wall2", Vector3(10.0f, 2.5f, 0.0f), Vector3(1.0f, 2.5f, 5.0f), true, 0.0f, true, false, Vector4(0.2f, 0.5f, 1.0f, 1.0f)));
	this->AddGameObject(BuildCuboidObject("Wall3", Vector3(5.0f, 2.5f, 5.0f), Vector3(5.0f, 2.5f, 1.0f), true, 0.0f, true, false, Vector4(0.2f, 0.5f, 1.0f, 1.0f)));
	this->AddGameObject(BuildCuboidObject("Wall4", Vector3(5.0f, 2.5f, -5.0f), Vector3(5.0f, 2.5f, 1.0f), true, 0.0f, true, false, Vector4(0.2f, 0.5f, 1.0f, 1.0f)));
	...
	create_ball_cube(Vector3(3.0f, 0.5f, -2.5f), Vector3(1.0f, 1.0f, 1.0f), 0.5f);

	
}

void Scene2::OnCleanupScene()
{
