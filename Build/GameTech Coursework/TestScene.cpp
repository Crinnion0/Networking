...
//<--- SCENE CREATION --->
	...
	//Create Pendulum Spheres
	

	GameObject* pendulumSphere = BuildSphereObject(
		"Pendulum",					// Optional: Name
		Vector3(4.0f, 4.0f, 12.0f),				// Position
	...
	this->AddGameObject(pendulumSphere);


	GameObject* pendulumSphereRoot = BuildSphereObject(
		"Pendulum",					// Optional: Name
		Vector3(4.0f, 12.0f, 12.0f),				// Position
		1.0f,			// Half-Dimensions
		true,				// Physics Enabled?
		10.f,				// Physical Mass (must have physics enabled)
		true,				// Physically Collidable (has collision shape)
	...
	this->AddGameObject(pendulumSphereRoot);
