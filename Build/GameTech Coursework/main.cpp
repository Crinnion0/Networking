...
void Initialize()
{
	...
	//Enqueue All Scenes
	SceneManager::Instance()->EnqueueScene(new TestScene("GameTech #1 - Sandbox!"));
	SceneManager::Instance()->EnqueueScene(new Scene2("GameTech #2 - Ballpit"));
	SceneManager::Instance()->EnqueueScene(new SoftBodyScene("GameTech #3 - SoftBody"));
...
void HandleKeyboardInputs()
{
	...
	if (Window::GetKeyboard()->KeyTriggered(KEYBOARD_J))
		SceneManager::Instance()->fireProjectile();
